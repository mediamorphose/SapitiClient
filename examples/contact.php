...
$newContact->setMobilePhone('1-555-99 99 98');
$newContact->setLanguage('en');
$newContact->setAddressCountry('lu');
$newContact->setNationality('be');
$birthDate = new DateTime(); $birthDate->modify('-50 year');
